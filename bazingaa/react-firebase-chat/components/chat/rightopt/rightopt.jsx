...
const Rightopt = ({setonclick,fn}) => {
    ...
    return (
        <div className="mainlay">
            ...
            <button className="imgusr"><i className="fa-solid fa-image"></i></button>
            <button className="linkusr"><i className="fa-solid fa-link"></i></button>
            <button className="fileusr"><i className="fa-regular fa-file"></i></button>
